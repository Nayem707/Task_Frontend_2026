      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="flex items-start gap-3 mb-4">
          ...
          <div className="relative flex-1">
            ...
            />
            <span className="pointer-events-none absolute right-3 top-3 text-[#888]">
              <svg
        ...
        <div className="flex items-center justify-between border-t border-[#edf1f7] pt-4">
          <div className="flex items-center gap-1">
            ...
            <button
              type="button"
              className="hidden sm:flex items-center gap-1.5 rounded-lg px-3 py-2 text-xs font-medium text-[#4c5a71] hover:bg-[#f3f7ff]"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
