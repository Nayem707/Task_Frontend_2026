        ...
        <ul className="space-y-1">
          {exploreItems.map((item) => (
            <li key={item.label}>
              <a
                href="#"
                className="flex items-center justify-between rounded-lg px-2 py-2.5 text-sm text-[#4c5a71] transition hover:bg-[#f3f7ff]"
              >
                ...
                {item.badge ? (
                  <span className="rounded-full bg-[#0ACF83] px-2 py-0.5 text-[10px] font-semibold text-white">
                    {item.badge}
                  </span>
                ) : null}
              </a>
