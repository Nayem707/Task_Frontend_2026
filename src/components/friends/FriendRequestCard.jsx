      ...
      <div className="p-2.5 sm:p-3">
        ...
        <div className="mt-2 flex gap-1.5 sm:mt-3 sm:gap-2">
          <button
            ...
            className="flex flex-1 items-center justify-center gap-1 rounded-full bg-blue-600 px-2.5 py-1.5 text-[10px] font-medium text-white transition hover:bg-blue-700 sm:px-3 sm:text-xs"
          >
            <UserCheck size={12} className="sm:size-[14px]" />
            Confirm
          </button>
          <button
